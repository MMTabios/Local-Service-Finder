...
<body>
    <div class="container">
        ...
        <form action="#">
            ...
            <div class="button">
                <button><a href="<?php echo e(route('homepage')); ?>">Register</a></button>
                <br><br>
                <button><a href="<?php echo e(route('login')); ?>">Go back</a></button>
            </div>
        </form>
    </div>
...
</html><?php /**PATH C:\Users\user\New_Project\resources\views/livewire/auth/auth-register.blade.php ENDPATH**/ ?>